...
3. Make a query on ``echo`` services via the ``search_services_wide`` method.
...
* when the agent receives a search result from the OEF (see ``on_search_result_wide``), it sends a CFP to
