...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\nfipa.proto\x12\x0c\x66\x65tch.oef.pb\x1a\x0bquery.proto\"\xb1\x04\n\x04\x46ipa\x1a\x8d\x01\n\x03\x43\x66p\x12*\n\x05query\x18\x01 \x01(\x0b\x32\x19.fetch.oef.pb.Query.ModelH\x00\x12\x11\n\x07\x63ontent\x18\x02 \x01(\x0cH\x00\x12\x31\n\x07nothing\x18\x03 \x01(\x0b\x32\x1e.fetch.oef.pb.Fipa.Cfp.NothingH\x00\x1a\t\n\x07NothingB\t\n\x07payload\x1a\x9e\x01\n\x07Propose\x12\x39\n\tproposals\x18\x01 \x01(\x0b\x32$.fetch.oef.pb.Fipa.Propose.ProposalsH\x00\x12\x11\n\x07\x63ontent\x18\x02 \x01(\x0cH\x00\x1a:\n\tProposals\x12-\n\x07objects\x18\x01 \x03(\x0b\x32\x1c.fetch.oef.pb.Query.InstanceB\t\n\x07payload\x1a\x08\n\x06\x41\x63\x63\x65pt\x1a\t\n\x07\x44\x65\x63line\x1a\xe2\x01\n\x07Message\x12\x0e\n\x06msg_id\x18\x01 \x02(\x05\x12\x0e\n\x06target\x18\x02 \x02(\x05\x12%\n\x03\x63\x66p\x18\x03 \x01(\x0b\x32\x16.fetch.oef.pb.Fipa.CfpH\x00\x12-\n\x07propose\x18\x04 \x01(\x0b\x32\x1a.fetch.oef.pb.Fipa.ProposeH\x00\x12+\n\x06\x61\x63\x63\x65pt\x18\x05 \x01(\x0b\x32\x19.fetch.oef.pb.Fipa.AcceptH\x00\x12-\n\x07\x64\x65\x63line\x18\x06 \x01(\x0b\x32\x1a.fetch.oef.pb.Fipa.DeclineH\x00\x42\x05\n\x03msg')
  ,
  dependencies=[query_pb2.DESCRIPTOR,])
...
_FIPA_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='fetch.oef.pb.Fipa.Message.msg_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target', full_name='fetch.oef.pb.Fipa.Message.target', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cfp', full_name='fetch.oef.pb.Fipa.Message.cfp', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='propose', full_name='fetch.oef.pb.Fipa.Message.propose', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='accept', full_name='fetch.oef.pb.Fipa.Message.accept', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decline', full_name='fetch.oef.pb.Fipa.Message.decline', index=5,
...
_FIPA_CFP.fields_by_name['query'].message_type = query_pb2._QUERY_MODEL
...
_FIPA_PROPOSE_PROPOSALS.fields_by_name['objects'].message_type = query_pb2._QUERY_INSTANCE
